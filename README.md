...
You have to design & build the backend for the application and the ability for the users to register, purchase membership, watch movies etc.
...
azaylamba/appletv: Apple TV Clone (github.com) 
